...
knitr::include_graphics("https://media.giphy.com/media/WM4jVa0RWdAVa/giphy.gif") 
```
...
* Similar questions in anthropology (e.g., Lenksi, 1974) and sociology (e.g., in functionalism of Talcott Parsons (1951)) .

---
## Ongoing debate

* The relative importance of culture versus ecology for 'societal complexity'. 

--

```{r, out.width = "600px", echo=FALSE, fig.align='center'}
knitr::include_graphics("Mathew_and_Pereault.png") # replace with screenshot of WNAI-D paper
``` 

---
## Research question

* 'Big question': What are the prerequisites for economic development.
...
* Macro-economists emphasize the importance of the rule of law.
...
```{r, out.width = "600px", echo=FALSE, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/O1kl1e6R4SCoE/giphy.gif") 
```
...
*  Technical variables (e.g., ID variable for the SCCS) from the dataset. 
...
* Machine learning challenge? How do other methods do?

--

* A potential reanalysis of WNAI-D

--

* 'Qualitative Comparative Analysis'. (necessary and sufficient causality)

--

* Phylogenetic work (Mathijs was working with Andrew Meade)
